      ...
      <Container>
        ...
        <Flex className="mt-14 xl:mt-20 gap-5 items-center xl:flex-row flex-col">
          ...
          <div className="xl:w-[60%]">
            <h2 className="text-[30px] text-black dark:text-white font-inter tracking-[1px] mb-5 font-semibold">
              About Me
            </h2>
            <p className=" font-poppins text-black dark:text-white text-[20px] leading-8 xl:text-left text-balance  font-normal ">
