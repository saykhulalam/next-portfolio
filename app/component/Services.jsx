    ...
    <section id="Services" className=" bg-dark-bg xl:py-20 py-16">
      <Container>
        ...
        <div className="one">
          ...
          <h2 className=" text-white font-poppins text-[20px] font-semibold mt-5">
            <span className="text-white font-poppins text-[20px] font-bold underline">
              Tools:
            </span>{" "}
            Figma, HTML, CSS, JavaScript
          </h2>
          <List className="mt-5">
            <ListItem className=" text-white flex xl:items-center gap-4 mt-4 font-poppins text-[15px] font-normal">
