...
const Services = () => {
  return (
    <section
      id="Services"
      className=" bg-white dark:bg-dark-bg xl:py-20 py-16 duration-200"
    >
      <Container>
        <Title Name="SERVICES" />
        <div className="one">
          <h1 className=" text-blue-600 font-poppins text-[25px] underline font-semibold mt-10">
            1. Figma Design to HTML Conversion
          </h1>
          <h2 className=" text-black dark:text-white font-poppins text-[20px] font-semibold mt-5">
            <span className="text-black dark:text-white font-poppins text-[20px] font-bold underline">
              Tools:
            </span>{" "}
            Figma, HTML, CSS, JavaScript
          </h2>
          <List className="mt-5">
            <ListItem className=" text-black dark:text-white flex xl:items-center gap-4 mt-4 font-poppins text-[15px] font-normal">
              <div className=" flex justify-center items-center w-[20px] h-[20px] rounded-full bg-black dark:bg-white ">
                <FaCheck className="text-white dark:text-black text-[15px]" />
              </div>
